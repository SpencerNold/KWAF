 ...
 */
class HttpRequest(val method: me.spencernold.kwaf.Http.Method, val url: String, val parameters: Map<String, String>, val headers: Map<String, String>, val body: ByteArray) {
     ...
     * @param url url to send the request to
     */
    class Builder(private val method: me.spencernold.kwaf.Http.Method, private val url: String, private var parameters: Map<String, String> = mapOf(), private var headers: Map<String, String> = mapOf(), private var body: ByteArray = ByteArray(0)) {
